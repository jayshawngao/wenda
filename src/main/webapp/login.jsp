            ...
            <div class="view view-signin" data-za-module="SignInForm" style="display: block;">
                <form action="<%=path %>/reg" id="regloginform" method="post">
                    ...
                    <div class="button-wrapper command clearfix">
                        <button class="sign-button submit" type="submit" onclick="form=document.getElementById('regloginform');form.action='<%=path %>/login'">登录</button>
                        <button class="sign-button submit" type="button" onclick="location.href='<%=path %>/register'">注册</button>
                    </div>
