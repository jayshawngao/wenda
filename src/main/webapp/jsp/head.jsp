...
<head>
    ...
    <script type="text/javascript">  
    	...
    	function log(obj_lis){
	        for(i=0;i<obj_lis.length;i++){
	            obj_lis[i].onclick = function(){
	                var element = this.getAttribute("href")+" "+this.textContent.trim();
	                res = $.ajax({url:"/wenda/data", data:{"element":element}, dataType:"json",async:false, type:"POST"});
	            }
	        }
    	}
