            ...
            Action[bFollow ? 'unFollowQuestion' : 'followQuestion']({
                ...
                call: function (oResult) {
                    ...
                    if (bFollow) {
                        ...
                        // 显示用户
                        oListEl.prepend('<a class="zm-item-link-avatar js-user-' + oResult.id + '" href="/wenda/user/' + oResult.id + '" data-original_title="' + oResult.name + '"><img src="' + oResult.headUrl + '" class="zm-item-img-avatar"></a>');
                    }
                },
                error: function (oResult) {
                    alert('出现错误，请重试');
